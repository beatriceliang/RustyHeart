...
class Box:
	...
	def pickUp(self):
		if(self.type=="cardboard"):
			if (self.rusty.rect.centery + self.rusty.rect.height/2 == self.rect.centery +self.rusty.rect.height/2): #and self.location[0] >= self.rusty.centerx+self.width/2 or self.location[0] +self.rect.width <= self.rusty.centerx+self.width/2)
